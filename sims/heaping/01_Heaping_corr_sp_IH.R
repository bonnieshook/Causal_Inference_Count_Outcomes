#Program: 01_Heaping_corr_sp_IH.R
#Developed by: BES
#Purpose: Simulate heaped data similar to WIHS, analyze using MSM, PG, and DR in geex
...
#generate the sample
  ...
  #set probability of reporting an exact count
  pi1<-0.5
  pi2<-0.2
